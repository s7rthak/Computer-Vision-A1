...
input_path = input_path = "COL780-A1-Data/ptz/input/"                     # Path to video for processing
height = 240                                      # Resolution of the video
width  = 320
...
coloured_frame = cv2.imread(input_path + "in" + str(1).zfill(6) + ".jpg")
coloured_frame = cv2.resize(coloured_frame, (320, 240))
